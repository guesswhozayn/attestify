...
// Hook companion for components that need to track scroll independently of the window
// (For instance, if you apply this to a specific scrolling container instead of the whole page)
