...
const StatCard = ({ label, value, icon: Icon, subtext, gradient, iconBg, iconColor, delay = 0, variant = 'default' }) => {
    if (variant === 'mini') {
        return (
            <motion.div
                ...
                className="bg-[#0c0c0c] p-5 rounded-4xl border border-white/5 flex flex-col items-center justify-center text-center group hover:bg-white/2 transition-colors"
            >
    ...
    return (
        <motion.div
            ...
            className="group relative overflow-hidden bg-[#0c0c0c] p-7 rounded-4xl border border-white/6 backdrop-blur-3xl hover:bg-white/4 hover:border-white/10 transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[0_20px_50px_-20px_rgba(0,0,0,0.5)]"
        >
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
                <div className="flex justify-between items-start mb-8">
                    ...
                    {subtext && (
                        <div className="flex items-center text-[10px] text-gray-400 font-bold bg-white/3 px-2.5 py-1.5 rounded-full border border-white/5 group-hover:border-white/10 transition-colors">
                ...
                <div>
                    ...
                    <div className="text-4xl font-black text-white mt-1 tracking-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-linear-to-r group-hover:from-white group-hover:to-gray-400 transition-all duration-500">
                        {value}
                    </div>
                </div>
            </div>
