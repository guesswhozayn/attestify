...
const StatCard = ({ label, value, icon: Icon, subtext, gradient, iconBg, delay = 0 }) => (
    ...
    >
        <div className={`absolute inset-0 bg-gradient-to-br ${gradient} opacity-0 group-hover:opacity-[0.03] transition-opacity duration-700 pointer-events-none`}></div>
        
        {/* Decorative corner light */}
        <div className="absolute -top-10 -right-10 w-32 h-32 bg-white/[0.02] rounded-full blur-[40px] group-hover:bg-white/[0.05] transition-colors duration-700"></div>
